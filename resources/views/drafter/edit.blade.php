                        ...
                        <div class="card-header">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 ">
                                    ...
                                    <p class="fw-bold">Verifikator : {{$surat->getVerifikator->name}} di verifikasi pada {{$surat->VerifiedAt}}</p>
                                    <div class="row">
                                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                                            aria-controls="offcanvasRight">Lihat Revisi</button>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control" data-trigger name="idJenis"
                                                ...
                                                @foreach ($kategori as $i)
                                                    <option value="{{ $i->id }}" @if($surat->idJenis == $i->id) selected @endif>
                                                        {{ $i->JenisSurat }}</option>
                                                @endforeach
                                            </select>
                                            @error('idJenis')
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control" data-trigger
                                                            ...
                                                            @foreach ($penerima as $p)
                                                                <option value="{{ $p->id }}"
                                                                    @if($surat->PenerimaSuratEksternal == $p->id) selected
                                                                    @endif>{{ $p->name }} -
                                                                    {{ $p->jabatan }}
                                                                </option>
                                                            @endforeach
                                        ...
                                        <div class="accordion-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" data-trigger name="CarbonCopy[]"
                                                    ...
                                                    @foreach ($penerima as $p)
                                                        <option value="{{ $p->id }}" @if(in_array($p->id, $surat->CarbonCopy))
                                                        selected @endif>{{ $p->name }} -
                                                            {{ $p->jabatan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control" data-trigger name="CarbonCopyExt[]"
                                                        ...
                                                        <option value="">Pilih penerima</option>
                                                        @foreach ($penerima as $p)
                                                            <option value="{{ $p->id }}" @if(in_array($p->id, $surat->CarbonCopy)) selected @endif>{{ $p->name }} -
                                                                {{ $p->jabatan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control" data-trigger name="BlindCarbonCopyInt[]"
                                                        ...
                                                        <option value="">Pilih penerima</option>
                                                        @foreach ($penerima as $p)
                                                            <option value="{{ $p->id }}" @if(in_array($p->id, $surat->BlindCarbonCopy)) selected @endif>{{ $p->name }} -
                                                                {{ $p->jabatan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="accordion-body">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control" data-trigger name="BlindCarbonCopyExt[]"
                                                            ...
                                                            <option value="">Pilih penerima</option>
                                                            @foreach ($penerima as $p)
                                                                <option value="{{ $p->id }}" @if(in_array($p->id, $surat->BlindCarbonCopyEks)) selected @endif>{{ $p->name }} -
                                                                    {{ $p->jabatan }}
                                                                </option>
                                                            @endforeach
                                                        </select>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body ">
            <div class="row mb-4 fw-bold fs-6">
                <div class="col-md-6">
                Deverifikasi Oleh {{$surat->getVerifikator->name}}
                </div>
                            <div class="col-md-6">
